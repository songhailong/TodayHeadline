...
struct WendaQuestion: HandyJSON {
    ...
    var title: String = ""
    var titleH: CGFloat? {
        return title.calculateHeight(fontSize: 16, width: screenWidth - 30)
    }
...
struct QuestionContent: HandyJSON {
    ...
    var text: String = ""
    var textH: CGFloat? {
        return text.calculateHeight(fontSize: 16, width: screenWidth - 30)
    }
    var large_image_list = [LargeImage]()
}
